                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-lg-8">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="recibir_publicidad">Proporciona permiso para
                                        utilizar sus datos?</label>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <button class="btn btn-dark" type="submit"><i class="far fa-credit-card"></i> Pagar
                                    ya</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="card border-0 rounded-0 p-lg-4 bg-light">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li class="d-flex align-items-center justify-content-between"><strong
                                        class="text-uppercase small fw-bold">Total</strong><span>${{ $precio }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
