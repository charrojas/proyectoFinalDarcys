                    ...
                    <div class="modal-body p-0">
                        <div class="row align-items-stretch">
                            <div class="col-lg-6 p-lg-0"><a
                                    class=" img-fluid glightbox product-view d-block h-100 bg-cover bg-center"
                                    style="background: url(img/{{ $item->img }})" href="img/{{ $item->img }}"
                ...
                <div class="product text-center">
                    <div class="mb-3 position-relative">
                        <div class="badge text-white bg-"></div><a class="d-block" href="detail.html"><img
                                class="img-fluid w-100" src="img/{{ $item->img }}" alt="..."
                                style="    height: 291px;"></a>
                        <div class="product-overlay">
                            <ul class="mb-0 list-inline">
                                ...
                                <li class="list-inline-item mr-0"><a class="btn btn-sm btn-outline-dark"
                                        href="#productView{{ $item->id_coctel }}" data-bs-toggle="modal"><i
