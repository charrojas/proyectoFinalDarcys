            ...
            <div class="container p-0">
                <div class="row">
                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        ...
                        <div class="py-2 px-4 bg-light mb-3"><strong class="small text-uppercase fw-bold"><a
                                    href="{{ route('categoria', $categorias[0]->id_categoria) }}">Cócteles
                                    Elegantes</a></strong></div>
                        <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                            @foreach ($coctelesE as $item)
                                <li class="mb-2"><a class="reset-anchor" href="#productView{{ $item->id_coctel }}"
                                        data-bs-toggle="modal">{{ $item->nombre }}</a></li>
                            @endforeach


                        </ul>
                        <div class="py-2 px-4 bg-light mb-3"><strong class="small text-uppercase fw-bold"><a
                                    href="{{ route('categoria', $categorias[1]->id_categoria) }}">Cócteles
                                    Infantiles</a></strong></div>
                        <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal">
                            @foreach ($coctelesI as $item)
                                <li class="mb-2"><a class="reset-anchor" href="#productView{{ $item->id_coctel }}"
                                        data-bs-toggle="modal">{{ $item->nombre }}</a></li>
                        ...
                        <div class="py-2 px-4 bg-light mb-3"><strong class="small text-uppercase fw-bold"><a
                                    href="{{ route('categoria', $categorias[3]->id_categoria) }}">Cócteles
                                    Artesanales</a></strong></div>
                        ...
                        <div class="py-2 px-4 bg-light mb-3"><strong class="small text-uppercase fw-bold"><a
                                    href="{{ route('categoria', $categorias[2]->id_categoria) }}">Cócteles de
                                    temporada</a></strong></div>
                        <ul class="list-unstyled small text-muted ps-lg-4 font-weight-normal mb-5">
                            @foreach ($coctelesT as $item)
                                <li class="mb-2"><a class="reset-anchor" href="#productView{{ $item->id_coctel }}"
                                        data-bs-toggle="modal">{{ $item->nombre }}</a></li>
