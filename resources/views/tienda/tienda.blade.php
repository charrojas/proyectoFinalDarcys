                        ...
                        <div class="modal-body p-0">
                            <div class="row align-items-stretch">
                                <div class="col-lg-6 p-lg-0"><a
                                        ...
                                        style=" width: 352px;background: url(img/{{ $item->img }})"
                                        href="img/{{ $item->img }}" data-gallery="gallery1"
                ...
                <div class="container py-5">
                    <div class="row px-4 px-lg-5">
                        <div class="col-lg-6">
                            ...
                            <h1 class="h2 text-uppercase mb-3">30% DE DESCUENTO EN INAUGURACIÓN</h1><a class="btn btn-dark"
                                href="#">Reserva tu espacio</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="pt-5">
                ...
                <div class="row">
                    <div class="col-md-4"><a class="category-item"
                            href="{{ route('categoria', $categoria[0]->id_categoria) }}"><img class="img-fluid"
                                src="img/cat-img-1.jpg" alt="" /><strong
                                class="category-item-title">Elegantes</strong></a>
                    </div>
                    <div class="col-md-4"><a class="category-item mb-4"
                            href="{{ route('categoria', $categoria[1]->id_categoria) }}"><img class="img-fluid"
                                src="img/cat-img-2.jpg" alt="" /><strong
                                class="category-item-title">Infantil</strong></a><a class="category-item"
                            href="{{ route('categoria', $categoria[3]->id_categoria) }}"><img class="img-fluid"
                                src="img/cat-img-3.jpg" alt="" /><strong
                                class="category-item-title">Artesanales</strong></a>
                    </div>
                    <div class="col-md-4"><a class="category-item"
                            href="{{ route('categoria', $categoria[2]->id_categoria) }}"><img class="img-fluid"
                                src="img/cat-img-4.jpg" alt="" /><strong
                                class="category-item-title">Temporada</strong></a>
                    </div>
                </div>
            </section>
            <!-- TRENDING PRODUCTS-->
                            ...
                            <div class="product text-center">
                                <div class="position-relative mb-3">
                                    <div class="badge text-white bg-"></div><a class="d-block" href="#"><img
                                            class="img-fluid w-100" src="img/{{ $item->img }}" alt="..."></a>
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark"
                                                    href="#"><i class="far fa-heart"></i></a></li>
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark">Ven y
                                                    probalo</a></li>
                                            <li class="list-inline-item me-0"><a class="btn btn-sm btn-outline-dark"
                                                    href="#productView{{ $item->id_coctel }}" data-bs-toggle="modal"
                                                    data-bs-target="#productView{{ $item->id_coctel }}">
